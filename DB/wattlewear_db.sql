...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 24, 2025 at 02:50 AM
...
--
-- Database: `wattlewear_db`
--

-- --------------------------------------------------------

--
-- Table structure for table `wwaddress`
--

DROP TABLE IF EXISTS `wwaddress`;
CREATE TABLE IF NOT EXISTS `wwaddress` (
...
--
-- Table structure for table `wwaddress_format`
--

DROP TABLE IF EXISTS `wwaddress_format`;
CREATE TABLE IF NOT EXISTS `wwaddress_format` (
...
--
-- Dumping data for table `wwaddress_format`
--

INSERT INTO `wwaddress_format` (`address_format_id`, `name`, `address_format`) VALUES
(1, 'Address Format', '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}');

-- --------------------------------------------------------

--
-- Table structure for table `wwantispam`
--

DROP TABLE IF EXISTS `wwantispam`;
CREATE TABLE IF NOT EXISTS `wwantispam` (
...
--
-- Table structure for table `wwapi`
--

DROP TABLE IF EXISTS `wwapi`;
CREATE TABLE IF NOT EXISTS `wwapi` (
...
--
-- Dumping data for table `wwapi`
--

INSERT INTO `wwapi` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2025-06-24 01:52:20', '2025-06-24 01:52:20');

-- --------------------------------------------------------

--
-- Table structure for table `wwapi_history`
--

DROP TABLE IF EXISTS `wwapi_history`;
CREATE TABLE IF NOT EXISTS `wwapi_history` (
...
--
-- Table structure for table `wwapi_ip`
--

DROP TABLE IF EXISTS `wwapi_ip`;
CREATE TABLE IF NOT EXISTS `wwapi_ip` (
...
--
-- Table structure for table `wwarticle`
--

DROP TABLE IF EXISTS `wwarticle`;
CREATE TABLE IF NOT EXISTS `wwarticle` (
...
--
-- Table structure for table `wwarticle_comment`
--

DROP TABLE IF EXISTS `wwarticle_comment`;
CREATE TABLE IF NOT EXISTS `wwarticle_comment` (
...
--
-- Table structure for table `wwarticle_description`
--

DROP TABLE IF EXISTS `wwarticle_description`;
CREATE TABLE IF NOT EXISTS `wwarticle_description` (
...
--
-- Table structure for table `wwarticle_rating`
--

DROP TABLE IF EXISTS `wwarticle_rating`;
CREATE TABLE IF NOT EXISTS `wwarticle_rating` (
...
--
-- Table structure for table `wwarticle_to_layout`
--

DROP TABLE IF EXISTS `wwarticle_to_layout`;
CREATE TABLE IF NOT EXISTS `wwarticle_to_layout` (
  `article_id` int NOT NULL,
...
--
-- Table structure for table `wwarticle_to_store`
--

DROP TABLE IF EXISTS `wwarticle_to_store`;
CREATE TABLE IF NOT EXISTS `wwarticle_to_store` (
  `article_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`article_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `wwattribute`
--

DROP TABLE IF EXISTS `wwattribute`;
CREATE TABLE IF NOT EXISTS `wwattribute` (
...
--
-- Dumping data for table `wwattribute`
--

INSERT INTO `wwattribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `wwattribute_description`
--

DROP TABLE IF EXISTS `wwattribute_description`;
CREATE TABLE IF NOT EXISTS `wwattribute_description` (
...
--
-- Dumping data for table `wwattribute_description`
--

INSERT INTO `wwattribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(3, 1, 'Clockspeed'),
(4, 1, 'test 1'),
...
--
-- Table structure for table `wwattribute_group`
--

DROP TABLE IF EXISTS `wwattribute_group`;
CREATE TABLE IF NOT EXISTS `wwattribute_group` (
...
--
-- Dumping data for table `wwattribute_group`
--

INSERT INTO `wwattribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `wwattribute_group_description`
--

DROP TABLE IF EXISTS `wwattribute_group_description`;
CREATE TABLE IF NOT EXISTS `wwattribute_group_description` (
...
--
-- Dumping data for table `wwattribute_group_description`
--

INSERT INTO `wwattribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Table structure for table `wwbanner`
--

DROP TABLE IF EXISTS `wwbanner`;
CREATE TABLE IF NOT EXISTS `wwbanner` (
...
--
-- Dumping data for table `wwbanner`
--

INSERT INTO `wwbanner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
--
-- Table structure for table `wwbanner_image`
--

DROP TABLE IF EXISTS `wwbanner_image`;
CREATE TABLE IF NOT EXISTS `wwbanner_image` (
...
--
-- Dumping data for table `wwbanner_image`
--

INSERT INTO `wwbanner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `wwcart`
--

DROP TABLE IF EXISTS `wwcart`;
CREATE TABLE IF NOT EXISTS `wwcart` (
...
--
-- Dumping data for table `wwcart`
--

INSERT INTO `wwcart` (`cart_id`, `store_id`, `customer_id`, `session_id`, `product_id`, `subscription_plan_id`, `option`, `quantity`, `override`, `price`, `date_added`) VALUES
(1, 0, 0, 'e5dd7030bfb7e3ec1181d16e93', 43, 0, '[]', 1, '[]', NULL, '2025-06-24 01:55:30');

-- --------------------------------------------------------

--
-- Table structure for table `wwcategory`
--

DROP TABLE IF EXISTS `wwcategory`;
CREATE TABLE IF NOT EXISTS `wwcategory` (
...
--
-- Dumping data for table `wwcategory`
--

INSERT INTO `wwcategory` (`category_id`, `image`, `parent_id`, `sort_order`, `status`) VALUES
(17, '', 0, 4, 1),
...
--
-- Table structure for table `wwcategory_description`
--

DROP TABLE IF EXISTS `wwcategory_description`;
CREATE TABLE IF NOT EXISTS `wwcategory_description` (
...
--
-- Dumping data for table `wwcategory_description`
--

INSERT INTO `wwcategory_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `wwcategory_filter`
--

DROP TABLE IF EXISTS `wwcategory_filter`;
CREATE TABLE IF NOT EXISTS `wwcategory_filter` (
  `category_id` int NOT NULL,
...
--
-- Table structure for table `wwcategory_path`
--

DROP TABLE IF EXISTS `wwcategory_path`;
CREATE TABLE IF NOT EXISTS `wwcategory_path` (
  `category_id` int NOT NULL,
...
--
-- Dumping data for table `wwcategory_path`
--

INSERT INTO `wwcategory_path` (`category_id`, `path_id`, `level`) VALUES
(17, 17, 0),
(18, 18, 0),
(20, 20, 0),
(24, 24, 0),
...
--
-- Table structure for table `wwcategory_to_layout`
--

DROP TABLE IF EXISTS `wwcategory_to_layout`;
CREATE TABLE IF NOT EXISTS `wwcategory_to_layout` (
  `category_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  `layout_id` int DEFAULT '0',
...
--
-- Table structure for table `wwcategory_to_store`
--

DROP TABLE IF EXISTS `wwcategory_to_store`;
CREATE TABLE IF NOT EXISTS `wwcategory_to_store` (
  `category_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `wwcategory_to_store`
--

INSERT INTO `wwcategory_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Table structure for table `wwcountry`
--

DROP TABLE IF EXISTS `wwcountry`;
CREATE TABLE IF NOT EXISTS `wwcountry` (
...
--
-- Dumping data for table `wwcountry`
--

INSERT INTO `wwcountry` (`country_id`, `iso_code_2`, `iso_code_3`, `address_format_id`, `postcode_required`, `status`) VALUES
(1, 'AF', 'AFG', 1, 0, 1),
(2, 'AL', 'ALB', 1, 0, 1),
(3, 'DZ', 'DZA', 1, 0, 1),
(4, 'AS', 'ASM', 1, 0, 1),
...
--
-- Table structure for table `wwcountry_description`
--

DROP TABLE IF EXISTS `wwcountry_description`;
CREATE TABLE IF NOT EXISTS `wwcountry_description` (
...
--
-- Dumping data for table `wwcountry_description`
--

INSERT INTO `wwcountry_description` (`country_id`, `language_id`, `name`) VALUES
...
--
-- Table structure for table `wwcoupon`
--

DROP TABLE IF EXISTS `wwcoupon`;
CREATE TABLE IF NOT EXISTS `wwcoupon` (
...
--
-- Dumping data for table `wwcoupon`
--

INSERT INTO `wwcoupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `wwcoupon_category`
--

DROP TABLE IF EXISTS `wwcoupon_category`;
CREATE TABLE IF NOT EXISTS `wwcoupon_category` (
...
--
-- Table structure for table `wwcoupon_history`
--

DROP TABLE IF EXISTS `wwcoupon_history`;
CREATE TABLE IF NOT EXISTS `wwcoupon_history` (
...
--
-- Table structure for table `wwcoupon_product`
--

DROP TABLE IF EXISTS `wwcoupon_product`;
CREATE TABLE IF NOT EXISTS `wwcoupon_product` (
...
--
-- Table structure for table `wwcron`
--

DROP TABLE IF EXISTS `wwcron`;
CREATE TABLE IF NOT EXISTS `wwcron` (
...
--
-- Dumping data for table `wwcron`
--

INSERT INTO `wwcron` (`cron_id`, `code`, `description`, `cycle`, `action`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `wwcurrency`
--

DROP TABLE IF EXISTS `wwcurrency`;
CREATE TABLE IF NOT EXISTS `wwcurrency` (
...
--
-- Dumping data for table `wwcurrency`
--

INSERT INTO `wwcurrency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
--
-- Table structure for table `wwcustomer`
--

DROP TABLE IF EXISTS `wwcustomer`;
CREATE TABLE IF NOT EXISTS `wwcustomer` (
...
--
-- Table structure for table `wwcustomer_activity`
--

DROP TABLE IF EXISTS `wwcustomer_activity`;
CREATE TABLE IF NOT EXISTS `wwcustomer_activity` (
...
--
-- Table structure for table `wwcustomer_affiliate`
--

DROP TABLE IF EXISTS `wwcustomer_affiliate`;
CREATE TABLE IF NOT EXISTS `wwcustomer_affiliate` (
...
--
-- Table structure for table `wwcustomer_affiliate_report`
--

DROP TABLE IF EXISTS `wwcustomer_affiliate_report`;
CREATE TABLE IF NOT EXISTS `wwcustomer_affiliate_report` (
...
--
-- Table structure for table `wwcustomer_approval`
--

DROP TABLE IF EXISTS `wwcustomer_approval`;
CREATE TABLE IF NOT EXISTS `wwcustomer_approval` (
...
--
-- Table structure for table `wwcustomer_authorize`
--

DROP TABLE IF EXISTS `wwcustomer_authorize`;
CREATE TABLE IF NOT EXISTS `wwcustomer_authorize` (
...
--
-- Table structure for table `wwcustomer_group`
--

DROP TABLE IF EXISTS `wwcustomer_group`;
CREATE TABLE IF NOT EXISTS `wwcustomer_group` (
...
--
-- Dumping data for table `wwcustomer_group`
--

INSERT INTO `wwcustomer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1),
(2, 0, 2),
(3, 1, 3);
...
--
-- Table structure for table `wwcustomer_group_description`
--

DROP TABLE IF EXISTS `wwcustomer_group_description`;
CREATE TABLE IF NOT EXISTS `wwcustomer_group_description` (
...
--
-- Dumping data for table `wwcustomer_group_description`
--

INSERT INTO `wwcustomer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
...
--
-- Table structure for table `wwcustomer_history`
--

DROP TABLE IF EXISTS `wwcustomer_history`;
CREATE TABLE IF NOT EXISTS `wwcustomer_history` (
...
--
-- Table structure for table `wwcustomer_ip`
--

DROP TABLE IF EXISTS `wwcustomer_ip`;
CREATE TABLE IF NOT EXISTS `wwcustomer_ip` (
...
--
-- Table structure for table `wwcustomer_login`
--

DROP TABLE IF EXISTS `wwcustomer_login`;
CREATE TABLE IF NOT EXISTS `wwcustomer_login` (
...
--
-- Table structure for table `wwcustomer_online`
--

DROP TABLE IF EXISTS `wwcustomer_online`;
CREATE TABLE IF NOT EXISTS `wwcustomer_online` (
...
--
-- Table structure for table `wwcustomer_reward`
--

DROP TABLE IF EXISTS `wwcustomer_reward`;
CREATE TABLE IF NOT EXISTS `wwcustomer_reward` (
...
--
-- Table structure for table `wwcustomer_search`
--

DROP TABLE IF EXISTS `wwcustomer_search`;
CREATE TABLE IF NOT EXISTS `wwcustomer_search` (
...
--
-- Table structure for table `wwcustomer_token`
--

DROP TABLE IF EXISTS `wwcustomer_token`;
CREATE TABLE IF NOT EXISTS `wwcustomer_token` (
...
--
-- Table structure for table `wwcustomer_transaction`
--

DROP TABLE IF EXISTS `wwcustomer_transaction`;
CREATE TABLE IF NOT EXISTS `wwcustomer_transaction` (
...
--
-- Table structure for table `wwcustomer_wishlist`
--

DROP TABLE IF EXISTS `wwcustomer_wishlist`;
CREATE TABLE IF NOT EXISTS `wwcustomer_wishlist` (
  `customer_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
...
--
-- Table structure for table `wwcustom_field`
--

DROP TABLE IF EXISTS `wwcustom_field`;
CREATE TABLE IF NOT EXISTS `wwcustom_field` (
...
--
-- Dumping data for table `wwcustom_field`
--

INSERT INTO `wwcustom_field` (`custom_field_id`, `type`, `value`, `validation`, `location`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `wwcustom_field_customer_group`
--

DROP TABLE IF EXISTS `wwcustom_field_customer_group`;
CREATE TABLE IF NOT EXISTS `wwcustom_field_customer_group` (
...
--
-- Dumping data for table `wwcustom_field_customer_group`
--

INSERT INTO `wwcustom_field_customer_group` (`custom_field_id`, `customer_group_id`, `required`) VALUES
(1, 1, 1),
(2, 1, 1),
(3, 1, 1),
(4, 1, 1),
...
--
-- Table structure for table `wwcustom_field_description`
--

DROP TABLE IF EXISTS `wwcustom_field_description`;
CREATE TABLE IF NOT EXISTS `wwcustom_field_description` (
  `custom_field_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `wwcustom_field_description`
--

INSERT INTO `wwcustom_field_description` (`custom_field_id`, `language_id`, `name`) VALUES
(1, 1, 'Select'),
(2, 1, 'Radio'),
(3, 1, 'Checkbox'),
(4, 1, 'Text'),
...
--
-- Table structure for table `wwcustom_field_value`
--

DROP TABLE IF EXISTS `wwcustom_field_value`;
CREATE TABLE IF NOT EXISTS `wwcustom_field_value` (
...
--
-- Dumping data for table `wwcustom_field_value`
--

INSERT INTO `wwcustom_field_value` (`custom_field_value_id`, `custom_field_id`, `sort_order`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
--
-- Table structure for table `wwcustom_field_value_description`
--

DROP TABLE IF EXISTS `wwcustom_field_value_description`;
CREATE TABLE IF NOT EXISTS `wwcustom_field_value_description` (
...
--
-- Dumping data for table `wwcustom_field_value_description`
--

INSERT INTO `wwcustom_field_value_description` (`custom_field_value_id`, `language_id`, `custom_field_id`, `name`) VALUES
(1, 1, 1, 'Test 1'),
(2, 1, 1, 'test 2'),
(3, 1, 1, 'Test 3'),
(4, 1, 2, 'Test 1'),
...
--
-- Table structure for table `wwdownload`
--

DROP TABLE IF EXISTS `wwdownload`;
CREATE TABLE IF NOT EXISTS `wwdownload` (
...
--
-- Table structure for table `wwdownload_description`
--

DROP TABLE IF EXISTS `wwdownload_description`;
CREATE TABLE IF NOT EXISTS `wwdownload_description` (
...
--
-- Table structure for table `wwdownload_report`
--

DROP TABLE IF EXISTS `wwdownload_report`;
CREATE TABLE IF NOT EXISTS `wwdownload_report` (
...
--
-- Table structure for table `wwevent`
--

DROP TABLE IF EXISTS `wwevent`;
CREATE TABLE IF NOT EXISTS `wwevent` (
...
--
-- Dumping data for table `wwevent`
--

INSERT INTO `wwevent` (`event_id`, `code`, `description`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `wwextension`
--

DROP TABLE IF EXISTS `wwextension`;
CREATE TABLE IF NOT EXISTS `wwextension` (
...
--
-- Dumping data for table `wwextension`
--

INSERT INTO `wwextension` (`extension_id`, `extension`, `type`, `code`) VALUES
...
--
-- Table structure for table `wwextension_install`
--

DROP TABLE IF EXISTS `wwextension_install`;
CREATE TABLE IF NOT EXISTS `wwextension_install` (
...
--
-- Dumping data for table `wwextension_install`
--

INSERT INTO `wwextension_install` (`extension_install_id`, `extension_id`, `extension_download_id`, `name`, `description`, `code`, `version`, `author`, `link`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `wwextension_path`
--

DROP TABLE IF EXISTS `wwextension_path`;
CREATE TABLE IF NOT EXISTS `wwextension_path` (
...
--
-- Dumping data for table `wwextension_path`
--

INSERT INTO `wwextension_path` (`extension_path_id`, `extension_install_id`, `path`) VALUES
(1, 1, 'opencart'),
(2, 1, 'opencart/admin'),
...
--
-- Table structure for table `wwfilter`
--

DROP TABLE IF EXISTS `wwfilter`;
CREATE TABLE IF NOT EXISTS `wwfilter` (
...
--
-- Table structure for table `wwfilter_description`
--

DROP TABLE IF EXISTS `wwfilter_description`;
CREATE TABLE IF NOT EXISTS `wwfilter_description` (
  `filter_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `wwfilter_group`
--

DROP TABLE IF EXISTS `wwfilter_group`;
CREATE TABLE IF NOT EXISTS `wwfilter_group` (
...
--
-- Table structure for table `wwfilter_group_description`
--

DROP TABLE IF EXISTS `wwfilter_group_description`;
CREATE TABLE IF NOT EXISTS `wwfilter_group_description` (
...
--
-- Table structure for table `wwgdpr`
--

DROP TABLE IF EXISTS `wwgdpr`;
CREATE TABLE IF NOT EXISTS `wwgdpr` (
...
--
-- Table structure for table `wwgeo_zone`
--

DROP TABLE IF EXISTS `wwgeo_zone`;
CREATE TABLE IF NOT EXISTS `wwgeo_zone` (
...
--
-- Dumping data for table `wwgeo_zone`
--

INSERT INTO `wwgeo_zone` (`geo_zone_id`, `name`, `description`) VALUES
...
--
-- Table structure for table `wwidentifier`
--

DROP TABLE IF EXISTS `wwidentifier`;
CREATE TABLE IF NOT EXISTS `wwidentifier` (
...
--
-- Dumping data for table `wwidentifier`
--

INSERT INTO `wwidentifier` (`identifier_id`, `name`, `code`, `validation`, `status`) VALUES
...
--
-- Table structure for table `wwinformation`
--

DROP TABLE IF EXISTS `wwinformation`;
CREATE TABLE IF NOT EXISTS `wwinformation` (
...
--
-- Dumping data for table `wwinformation`
--

INSERT INTO `wwinformation` (`information_id`, `sort_order`, `status`) VALUES
(1, 3, 1),
(2, 1, 1),
(3, 4, 1),
(4, 2, 1);
...
--
-- Table structure for table `wwinformation_description`
--

DROP TABLE IF EXISTS `wwinformation_description`;
CREATE TABLE IF NOT EXISTS `wwinformation_description` (
...
--
-- Dumping data for table `wwinformation_description`
--

INSERT INTO `wwinformation_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(1, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
--
-- Table structure for table `wwinformation_to_layout`
--

DROP TABLE IF EXISTS `wwinformation_to_layout`;
CREATE TABLE IF NOT EXISTS `wwinformation_to_layout` (
  `information_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  `layout_id` int DEFAULT '0',
...
--
-- Table structure for table `wwinformation_to_store`
--

DROP TABLE IF EXISTS `wwinformation_to_store`;
CREATE TABLE IF NOT EXISTS `wwinformation_to_store` (
  `information_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `wwinformation_to_store`
--

INSERT INTO `wwinformation_to_store` (`information_id`, `store_id`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0);
...
--
-- Table structure for table `wwlanguage`
--

DROP TABLE IF EXISTS `wwlanguage`;
CREATE TABLE IF NOT EXISTS `wwlanguage` (
...
--
-- Dumping data for table `wwlanguage`
--

INSERT INTO `wwlanguage` (`language_id`, `name`, `code`, `locale`, `extension`, `sort_order`, `status`) VALUES
(1, 'English', 'en-gb', 'en-gb,en', NULL, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `wwlayout`
--

DROP TABLE IF EXISTS `wwlayout`;
CREATE TABLE IF NOT EXISTS `wwlayout` (
...
--
-- Dumping data for table `wwlayout`
--

INSERT INTO `wwlayout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `wwlayout_module`
--

DROP TABLE IF EXISTS `wwlayout_module`;
CREATE TABLE IF NOT EXISTS `wwlayout_module` (
...
--
-- Dumping data for table `wwlayout_module`
--

INSERT INTO `wwlayout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
...
--
-- Table structure for table `wwlayout_route`
--

DROP TABLE IF EXISTS `wwlayout_route`;
CREATE TABLE IF NOT EXISTS `wwlayout_route` (
...
--
-- Dumping data for table `wwlayout_route`
--

INSERT INTO `wwlayout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(1, 6, 0, 'account/%'),
...
--
-- Table structure for table `wwlength_class`
--

DROP TABLE IF EXISTS `wwlength_class`;
CREATE TABLE IF NOT EXISTS `wwlength_class` (
...
--
-- Dumping data for table `wwlength_class`
--

INSERT INTO `wwlength_class` (`length_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 10.00000000),
(3, 0.39370000);
...
--
-- Table structure for table `wwlength_class_description`
--

DROP TABLE IF EXISTS `wwlength_class_description`;
CREATE TABLE IF NOT EXISTS `wwlength_class_description` (
...
--
-- Dumping data for table `wwlength_class_description`
--

INSERT INTO `wwlength_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Table structure for table `wwlocation`
--

DROP TABLE IF EXISTS `wwlocation`;
CREATE TABLE IF NOT EXISTS `wwlocation` (
...
--
-- Table structure for table `wwmanufacturer`
--

DROP TABLE IF EXISTS `wwmanufacturer`;
CREATE TABLE IF NOT EXISTS `wwmanufacturer` (
...
--
-- Dumping data for table `wwmanufacturer`
--

INSERT INTO `wwmanufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `wwmanufacturer_to_layout`
--

DROP TABLE IF EXISTS `wwmanufacturer_to_layout`;
CREATE TABLE IF NOT EXISTS `wwmanufacturer_to_layout` (
...
--
-- Table structure for table `wwmanufacturer_to_store`
--

DROP TABLE IF EXISTS `wwmanufacturer_to_store`;
CREATE TABLE IF NOT EXISTS `wwmanufacturer_to_store` (
  `manufacturer_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`manufacturer_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `wwmanufacturer_to_store`
--

INSERT INTO `wwmanufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `wwmarketing`
--

DROP TABLE IF EXISTS `wwmarketing`;
CREATE TABLE IF NOT EXISTS `wwmarketing` (
...
--
-- Table structure for table `wwmarketing_report`
--

DROP TABLE IF EXISTS `wwmarketing_report`;
CREATE TABLE IF NOT EXISTS `wwmarketing_report` (
...
--
-- Table structure for table `wwmodification`
--

DROP TABLE IF EXISTS `wwmodification`;
CREATE TABLE IF NOT EXISTS `wwmodification` (
...
--
-- Table structure for table `wwmodule`
--

DROP TABLE IF EXISTS `wwmodule`;
CREATE TABLE IF NOT EXISTS `wwmodule` (
...
--
-- Dumping data for table `wwmodule`
--

INSERT INTO `wwmodule` (`module_id`, `name`, `code`, `setting`) VALUES
...
--
-- Table structure for table `wwnotification`
--

DROP TABLE IF EXISTS `wwnotification`;
CREATE TABLE IF NOT EXISTS `wwnotification` (
...
--
-- Table structure for table `wwoption`
--

DROP TABLE IF EXISTS `wwoption`;
CREATE TABLE IF NOT EXISTS `wwoption` (
...
--
-- Dumping data for table `wwoption`
--

INSERT INTO `wwoption` (`option_id`, `type`, `validation`, `sort_order`) VALUES
(1, 'radio', NULL, 1),
(2, 'checkbox', NULL, 2),
(4, 'text', NULL, 3),
(5, 'select', NULL, 4),
...
--
-- Table structure for table `wwoption_description`
--

DROP TABLE IF EXISTS `wwoption_description`;
CREATE TABLE IF NOT EXISTS `wwoption_description` (
...
--
-- Dumping data for table `wwoption_description`
--

INSERT INTO `wwoption_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(5, 1, 'Select'),
...
--
-- Table structure for table `wwoption_value`
--

DROP TABLE IF EXISTS `wwoption_value`;
CREATE TABLE IF NOT EXISTS `wwoption_value` (
...
--
-- Dumping data for table `wwoption_value`
--

INSERT INTO `wwoption_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(23, 2, '', 1),
(24, 2, '', 2),
(31, 1, '', 2),
(32, 1, '', 1),
...
--
-- Table structure for table `wwoption_value_description`
--

DROP TABLE IF EXISTS `wwoption_value_description`;
CREATE TABLE IF NOT EXISTS `wwoption_value_description` (
...
--
-- Dumping data for table `wwoption_value_description`
--

INSERT INTO `wwoption_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(23, 1, 2, 'Checkbox 1'),
(24, 1, 2, 'Checkbox 2'),
(31, 1, 1, 'Medium'),
(32, 1, 1, 'Small'),
...
--
-- Table structure for table `wworder`
--

DROP TABLE IF EXISTS `wworder`;
CREATE TABLE IF NOT EXISTS `wworder` (
...
--
-- Table structure for table `wworder_history`
--

DROP TABLE IF EXISTS `wworder_history`;
CREATE TABLE IF NOT EXISTS `wworder_history` (
...
--
-- Table structure for table `wworder_option`
--

DROP TABLE IF EXISTS `wworder_option`;
CREATE TABLE IF NOT EXISTS `wworder_option` (
...
--
-- Table structure for table `wworder_product`
--

DROP TABLE IF EXISTS `wworder_product`;
CREATE TABLE IF NOT EXISTS `wworder_product` (
...
--
-- Table structure for table `wworder_status`
--

DROP TABLE IF EXISTS `wworder_status`;
CREATE TABLE IF NOT EXISTS `wworder_status` (
...
--
-- Dumping data for table `wworder_status`
--

INSERT INTO `wworder_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `wworder_subscription`
--

DROP TABLE IF EXISTS `wworder_subscription`;
CREATE TABLE IF NOT EXISTS `wworder_subscription` (
...
--
-- Table structure for table `wworder_total`
--

DROP TABLE IF EXISTS `wworder_total`;
CREATE TABLE IF NOT EXISTS `wworder_total` (
...
--
-- Table structure for table `wwproduct`
--

DROP TABLE IF EXISTS `wwproduct`;
CREATE TABLE IF NOT EXISTS `wwproduct` (
...
--
-- Table structure for table `wwproduct_attribute`
--

DROP TABLE IF EXISTS `wwproduct_attribute`;
CREATE TABLE IF NOT EXISTS `wwproduct_attribute` (
  `product_id` int NOT NULL,
  `attribute_id` int NOT NULL,
  `language_id` int NOT NULL,
  `text` text COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data for table `wwproduct_attribute`
--

INSERT INTO `wwproduct_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(42, 3, 1, '100mhz'),
(43, 2, 1, '1'),
(43, 4, 1, '8gb'),
(47, 2, 1, '4'),
...
--
-- Table structure for table `wwproduct_code`
--

DROP TABLE IF EXISTS `wwproduct_code`;
CREATE TABLE IF NOT EXISTS `wwproduct_code` (
...
--
-- Table structure for table `wwproduct_description`
--

DROP TABLE IF EXISTS `wwproduct_description`;
CREATE TABLE IF NOT EXISTS `wwproduct_description` (
  `product_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data for table `wwproduct_description`
--

INSERT INTO `wwproduct_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `wwproduct_discount`
--

DROP TABLE IF EXISTS `wwproduct_discount`;
CREATE TABLE IF NOT EXISTS `wwproduct_discount` (
...
--
-- Dumping data for table `wwproduct_discount`
--

INSERT INTO `wwproduct_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `type`, `special`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `wwproduct_filter`
--

DROP TABLE IF EXISTS `wwproduct_filter`;
CREATE TABLE IF NOT EXISTS `wwproduct_filter` (
  `product_id` int NOT NULL,
  `filter_id` int NOT NULL,
...
--
-- Table structure for table `wwproduct_image`
--

DROP TABLE IF EXISTS `wwproduct_image`;
CREATE TABLE IF NOT EXISTS `wwproduct_image` (
...
--
-- Dumping data for table `wwproduct_image`
--

INSERT INTO `wwproduct_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `wwproduct_option`
--

DROP TABLE IF EXISTS `wwproduct_option`;
CREATE TABLE IF NOT EXISTS `wwproduct_option` (
...
--
-- Dumping data for table `wwproduct_option`
--

INSERT INTO `wwproduct_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(208, 42, 4, 'test', 1),
(209, 42, 6, '', 1),
(217, 42, 5, '', 1),
(218, 42, 1, '', 1),
...
--
-- Table structure for table `wwproduct_option_value`
--

DROP TABLE IF EXISTS `wwproduct_option_value`;
CREATE TABLE IF NOT EXISTS `wwproduct_option_value` (
...
--
-- Dumping data for table `wwproduct_option_value`
--

INSERT INTO `wwproduct_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Table structure for table `wwproduct_related`
--

DROP TABLE IF EXISTS `wwproduct_related`;
CREATE TABLE IF NOT EXISTS `wwproduct_related` (
  `product_id` int NOT NULL,
...
--
-- Dumping data for table `wwproduct_related`
--

INSERT INTO `wwproduct_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Table structure for table `wwproduct_report`
--

DROP TABLE IF EXISTS `wwproduct_report`;
CREATE TABLE IF NOT EXISTS `wwproduct_report` (
...
--
-- Table structure for table `wwproduct_reward`
--

DROP TABLE IF EXISTS `wwproduct_reward`;
CREATE TABLE IF NOT EXISTS `wwproduct_reward` (
...
--
-- Dumping data for table `wwproduct_reward`
--

INSERT INTO `wwproduct_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(329, 43, 1, 600),
(331, 44, 1, 700),
(333, 45, 1, 800),
(335, 40, 1, 0),
...
--
-- Table structure for table `wwproduct_subscription`
--

DROP TABLE IF EXISTS `wwproduct_subscription`;
CREATE TABLE IF NOT EXISTS `wwproduct_subscription` (
  `product_id` int NOT NULL,
...
--
-- Table structure for table `wwproduct_to_category`
--

DROP TABLE IF EXISTS `wwproduct_to_category`;
CREATE TABLE IF NOT EXISTS `wwproduct_to_category` (
  `product_id` int NOT NULL,
  `category_id` int NOT NULL,
...
--
-- Dumping data for table `wwproduct_to_category`
--

INSERT INTO `wwproduct_to_category` (`product_id`, `category_id`) VALUES
(43, 18),
(44, 18),
(45, 18),
(46, 18),
...
--
-- Table structure for table `wwproduct_to_download`
--

DROP TABLE IF EXISTS `wwproduct_to_download`;
CREATE TABLE IF NOT EXISTS `wwproduct_to_download` (
  `product_id` int NOT NULL,
  `download_id` int NOT NULL,
...
--
-- Table structure for table `wwproduct_to_layout`
--

DROP TABLE IF EXISTS `wwproduct_to_layout`;
CREATE TABLE IF NOT EXISTS `wwproduct_to_layout` (
  `product_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  `layout_id` int DEFAULT '0',
...
--
-- Table structure for table `wwproduct_to_store`
--

DROP TABLE IF EXISTS `wwproduct_to_store`;
CREATE TABLE IF NOT EXISTS `wwproduct_to_store` (
  `product_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `wwproduct_to_store`
--

INSERT INTO `wwproduct_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Table structure for table `wwproduct_viewed`
--

DROP TABLE IF EXISTS `wwproduct_viewed`;
CREATE TABLE IF NOT EXISTS `wwproduct_viewed` (
  `product_id` int NOT NULL,
...
--
-- Table structure for table `wwreturn`
--

DROP TABLE IF EXISTS `wwreturn`;
CREATE TABLE IF NOT EXISTS `wwreturn` (
...
--
-- Table structure for table `wwreturn_action`
--

DROP TABLE IF EXISTS `wwreturn_action`;
CREATE TABLE IF NOT EXISTS `wwreturn_action` (
...
--
-- Dumping data for table `wwreturn_action`
--

INSERT INTO `wwreturn_action` (`return_action_id`, `language_id`, `name`) VALUES
...
--
-- Table structure for table `wwreturn_history`
--

DROP TABLE IF EXISTS `wwreturn_history`;
CREATE TABLE IF NOT EXISTS `wwreturn_history` (
...
--
-- Table structure for table `wwreturn_reason`
--

DROP TABLE IF EXISTS `wwreturn_reason`;
CREATE TABLE IF NOT EXISTS `wwreturn_reason` (
...
--
-- Dumping data for table `wwreturn_reason`
--

INSERT INTO `wwreturn_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `wwreturn_status`
--

DROP TABLE IF EXISTS `wwreturn_status`;
CREATE TABLE IF NOT EXISTS `wwreturn_status` (
...
--
-- Dumping data for table `wwreturn_status`
--

INSERT INTO `wwreturn_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
...
--
-- Table structure for table `wwreview`
--

DROP TABLE IF EXISTS `wwreview`;
CREATE TABLE IF NOT EXISTS `wwreview` (
...
--
-- Table structure for table `wwseo_url`
--

DROP TABLE IF EXISTS `wwseo_url`;
CREATE TABLE IF NOT EXISTS `wwseo_url` (
...
--
-- Dumping data for table `wwseo_url`
--

INSERT INTO `wwseo_url` (`seo_url_id`, `store_id`, `language_id`, `key`, `value`, `keyword`, `sort_order`) VALUES
...
--
-- Table structure for table `wwsession`
--

DROP TABLE IF EXISTS `wwsession`;
CREATE TABLE IF NOT EXISTS `wwsession` (
...
--
-- Dumping data for table `wwsession`
--

INSERT INTO `wwsession` (`session_id`, `data`, `expire`) VALUES
('c83c2973939a106da051404c66', '{\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"d90292a5c253054e39fbdc643f088e06\"}', '2025-06-25 02:21:34'),
('e5dd7030bfb7e3ec1181d16e93', '{\"currency\":\"USD\",\"login_token\":\"8e380af39f5e0adeaabad03711a2b67c\"}', '2025-06-25 02:00:48');

-- --------------------------------------------------------

--
-- Table structure for table `wwsetting`
--

DROP TABLE IF EXISTS `wwsetting`;
CREATE TABLE IF NOT EXISTS `wwsetting` (
...
--
-- Dumping data for table `wwsetting`
--

INSERT INTO `wwsetting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(101, 0, 'config', 'config_email', 'danushka.perera@ticgroup.com.au', 0),
...
--
-- Table structure for table `wwstartup`
--

DROP TABLE IF EXISTS `wwstartup`;
CREATE TABLE IF NOT EXISTS `wwstartup` (
...
--
-- Table structure for table `wwstatistics`
--

DROP TABLE IF EXISTS `wwstatistics`;
CREATE TABLE IF NOT EXISTS `wwstatistics` (
...
--
-- Dumping data for table `wwstatistics`
--

INSERT INTO `wwstatistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', 0.0000),
...
--
-- Table structure for table `wwstock_status`
--

DROP TABLE IF EXISTS `wwstock_status`;
CREATE TABLE IF NOT EXISTS `wwstock_status` (
...
--
-- Dumping data for table `wwstock_status`
--

INSERT INTO `wwstock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days'),
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order');
...
--
-- Table structure for table `wwstore`
--

DROP TABLE IF EXISTS `wwstore`;
CREATE TABLE IF NOT EXISTS `wwstore` (
...
--
-- Table structure for table `wwsubscription`
--

DROP TABLE IF EXISTS `wwsubscription`;
CREATE TABLE IF NOT EXISTS `wwsubscription` (
...
--
-- Table structure for table `wwsubscription_history`
--

DROP TABLE IF EXISTS `wwsubscription_history`;
CREATE TABLE IF NOT EXISTS `wwsubscription_history` (
...
--
-- Table structure for table `wwsubscription_log`
--

DROP TABLE IF EXISTS `wwsubscription_log`;
CREATE TABLE IF NOT EXISTS `wwsubscription_log` (
...
--
-- Table structure for table `wwsubscription_option`
--

DROP TABLE IF EXISTS `wwsubscription_option`;
CREATE TABLE IF NOT EXISTS `wwsubscription_option` (
...
--
-- Table structure for table `wwsubscription_plan`
--

DROP TABLE IF EXISTS `wwsubscription_plan`;
CREATE TABLE IF NOT EXISTS `wwsubscription_plan` (
...
--
-- Dumping data for table `wwsubscription_plan`
--

INSERT INTO `wwsubscription_plan` (`subscription_plan_id`, `trial_frequency`, `trial_duration`, `trial_cycle`, `trial_status`, `frequency`, `duration`, `cycle`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `wwsubscription_plan_description`
--

DROP TABLE IF EXISTS `wwsubscription_plan_description`;
CREATE TABLE IF NOT EXISTS `wwsubscription_plan_description` (
  `subscription_plan_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `wwsubscription_plan_description`
--

INSERT INTO `wwsubscription_plan_description` (`subscription_plan_id`, `language_id`, `name`) VALUES
(1, 1, 'Daily'),
(2, 1, 'Weekly'),
(3, 1, 'Monthly');
...
--
-- Table structure for table `wwsubscription_product`
--

DROP TABLE IF EXISTS `wwsubscription_product`;
CREATE TABLE IF NOT EXISTS `wwsubscription_product` (
...
--
-- Table structure for table `wwsubscription_status`
--

DROP TABLE IF EXISTS `wwsubscription_status`;
CREATE TABLE IF NOT EXISTS `wwsubscription_status` (
...
--
-- Dumping data for table `wwsubscription_status`
--

INSERT INTO `wwsubscription_status` (`subscription_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Active'),
(3, 1, 'Expired'),
(4, 1, 'Suspended'),
...
--
-- Table structure for table `wwtax_class`
--

DROP TABLE IF EXISTS `wwtax_class`;
CREATE TABLE IF NOT EXISTS `wwtax_class` (
...
--
-- Dumping data for table `wwtax_class`
--

INSERT INTO `wwtax_class` (`tax_class_id`, `title`, `description`) VALUES
...
--
-- Table structure for table `wwtax_rate`
--

DROP TABLE IF EXISTS `wwtax_rate`;
CREATE TABLE IF NOT EXISTS `wwtax_rate` (
...
--
-- Dumping data for table `wwtax_rate`
--

INSERT INTO `wwtax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`) VALUES
...
--
-- Table structure for table `wwtax_rate_to_customer_group`
--

DROP TABLE IF EXISTS `wwtax_rate_to_customer_group`;
CREATE TABLE IF NOT EXISTS `wwtax_rate_to_customer_group` (
...
--
-- Dumping data for table `wwtax_rate_to_customer_group`
--

INSERT INTO `wwtax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `wwtax_rule`
--

DROP TABLE IF EXISTS `wwtax_rule`;
CREATE TABLE IF NOT EXISTS `wwtax_rule` (
...
--
-- Dumping data for table `wwtax_rule`
--

INSERT INTO `wwtax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(120, 10, 87, 'store', 0),
(121, 10, 86, 'payment', 1),
(127, 9, 87, 'shipping', 2),
(128, 9, 86, 'shipping', 1);
...
--
-- Table structure for table `wwtheme`
--

DROP TABLE IF EXISTS `wwtheme`;
CREATE TABLE IF NOT EXISTS `wwtheme` (
...
--
-- Table structure for table `wwtopic`
--

DROP TABLE IF EXISTS `wwtopic`;
CREATE TABLE IF NOT EXISTS `wwtopic` (
...
--
-- Table structure for table `wwtopic_description`
--

DROP TABLE IF EXISTS `wwtopic_description`;
CREATE TABLE IF NOT EXISTS `wwtopic_description` (
...
--
-- Table structure for table `wwtopic_to_layout`
--

DROP TABLE IF EXISTS `wwtopic_to_layout`;
CREATE TABLE IF NOT EXISTS `wwtopic_to_layout` (
  `topic_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  `layout_id` int DEFAULT '0',
...
--
-- Table structure for table `wwtopic_to_store`
--

DROP TABLE IF EXISTS `wwtopic_to_store`;
CREATE TABLE IF NOT EXISTS `wwtopic_to_store` (
  `topic_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`topic_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `wwtranslation`
--

DROP TABLE IF EXISTS `wwtranslation`;
CREATE TABLE IF NOT EXISTS `wwtranslation` (
...
--
-- Table structure for table `wwupload`
--

DROP TABLE IF EXISTS `wwupload`;
CREATE TABLE IF NOT EXISTS `wwupload` (
...
--
-- Table structure for table `wwuser`
--

DROP TABLE IF EXISTS `wwuser`;
CREATE TABLE IF NOT EXISTS `wwuser` (
...
--
-- Dumping data for table `wwuser`
--

INSERT INTO `wwuser` (`user_id`, `user_group_id`, `username`, `password`, `firstname`, `lastname`, `email`, `image`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '$2y$10$a9xV.7lbYFjkVLpgzeoeR.n7RoNbAHsVVXycBf4IdSh2WqBgN9Pl6', 'John', 'Doe', 'danushka.perera@ticgroup.com.au', '', '::1', 1, '2025-06-24 01:52:20');

-- --------------------------------------------------------

--
-- Table structure for table `wwuser_authorize`
--

DROP TABLE IF EXISTS `wwuser_authorize`;
CREATE TABLE IF NOT EXISTS `wwuser_authorize` (
...
--
-- Table structure for table `wwuser_group`
--

DROP TABLE IF EXISTS `wwuser_group`;
CREATE TABLE IF NOT EXISTS `wwuser_group` (
...
--
-- Dumping data for table `wwuser_group`
--

INSERT INTO `wwuser_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Table structure for table `wwuser_login`
--

DROP TABLE IF EXISTS `wwuser_login`;
CREATE TABLE IF NOT EXISTS `wwuser_login` (
...
--
-- Dumping data for table `wwuser_login`
--

INSERT INTO `wwuser_login` (`user_login_id`, `user_id`, `ip`, `user_agent`, `date_added`) VALUES
(1, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', '2025-06-24 02:02:04'),
(2, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', '2025-06-24 02:20:36');

-- --------------------------------------------------------

--
-- Table structure for table `wwuser_token`
--

DROP TABLE IF EXISTS `wwuser_token`;
CREATE TABLE IF NOT EXISTS `wwuser_token` (
...
--
-- Table structure for table `wwweight_class`
--

DROP TABLE IF EXISTS `wwweight_class`;
CREATE TABLE IF NOT EXISTS `wwweight_class` (
...
--
-- Dumping data for table `wwweight_class`
--

INSERT INTO `wwweight_class` (`weight_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 1000.00000000),
(3, 2.20460000),
(4, 35.27400000);
...
--
-- Table structure for table `wwweight_class_description`
--

DROP TABLE IF EXISTS `wwweight_class_description`;
CREATE TABLE IF NOT EXISTS `wwweight_class_description` (
...
--
-- Dumping data for table `wwweight_class_description`
--

INSERT INTO `wwweight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(3, 1, 'Pound ', 'lb'),
(4, 1, 'Ounce', 'oz');
...
--
-- Table structure for table `wwzone`
--

DROP TABLE IF EXISTS `wwzone`;
CREATE TABLE IF NOT EXISTS `wwzone` (
...
--
-- Dumping data for table `wwzone`
--

INSERT INTO `wwzone` (`zone_id`, `country_id`, `code`, `status`) VALUES
(1, 1, 'BDS', 1),
(2, 1, 'BDG', 1),
(3, 1, 'BGL', 1),
(4, 1, 'BAL', 1),
...
--
-- Table structure for table `wwzone_description`
--

DROP TABLE IF EXISTS `wwzone_description`;
CREATE TABLE IF NOT EXISTS `wwzone_description` (
...
--
-- Dumping data for table `wwzone_description`
--

INSERT INTO `wwzone_description` (`zone_id`, `language_id`, `name`) VALUES
(3507, 1, '\'Ajman'),
(919, 1, '\'Ali Sabih'),
(1704, 1, '\'Amman'),
(2881, 1, '\'Asir'),
...
--
-- Table structure for table `wwzone_to_geo_zone`
--

DROP TABLE IF EXISTS `wwzone_to_geo_zone`;
CREATE TABLE IF NOT EXISTS `wwzone_to_geo_zone` (
...
--
-- Dumping data for table `wwzone_to_geo_zone`
--

INSERT INTO `wwzone_to_geo_zone` (`zone_to_geo_zone_id`, `geo_zone_id`, `country_id`, `zone_id`) VALUES
(1, 4, 222, 0),
(2, 3, 222, 3513),
(3, 3, 222, 3514),
(4, 3, 222, 3515),
